---
title: "\"Database Copies/データベース コピー\" 役割: Exchange 2013 Help"
TOCTitle: "\"Database Copies/データベース コピー\" 役割"
ms:assetid: 71a95f5b-1f75-4ae9-9ee9-515c3a19d394
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876905(v=EXCHG.150)
ms:contentKeyID: 49896308
ms.date: 04/24/2018
...
`Database Copies` 管理役割を割り当てられた管理者は、個々のサーバー上のデータベース コピーを追加、削除、中断、再開、表示、および更新することができます。
...
この役割に含まれている **Set-MailboxDatabaseCopy** および **Remove-MailboxDatabaseCopy** コマンドレットを実行するには、構成または削除するデータベースはデータベース スコープ内にあり、さらにデータベースはサーバー スコープ内にあるサーバー上になければなりません。スコープの詳細については、「[管理役割スコープについて](understanding-management-role-scopes-exchange-2013-help.md)」を参照してください。
