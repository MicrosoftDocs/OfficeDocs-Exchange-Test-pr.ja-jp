---
title: "\"Database Availability Groups/データベース可用性グループ\" 役割: Exchange 2013 Help"
TOCTitle: "\"Database Availability Groups/データベース可用性グループ\" 役割"
ms:assetid: 0b3e0f7a-21e5-4209-8d5b-b63c6b9de3cc
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876847(v=EXCHG.150)
ms:contentKeyID: 49895231
ms.date: 04/24/2018
...
`Database Availability Groups` 管理役割により、管理者は組織内のデータベース可用性グループを管理できます。この役割を直接的または間接的に割り当てられている管理者は、組織内の高可用性構成の責任を負う、最高レベルの管理者です。
