---
title: "\"Journaling/ジャーナリング\" 役割: Exchange 2013 Help"
TOCTitle: "\"Journaling/ジャーナリング\" 役割"
ms:assetid: 64608dbe-d4b4-444e-a7df-bc536c4da202
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876894(v=EXCHG.150)
ms:contentKeyID: 49896284
ms.date: 04/24/2018
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# \"Journaling/ジャーナリング\" 役割
...
管理者は `Journaling` 管理役割を使用して、組織内でジャーナル ルールを作成、変更、有効化、無効化、表示、または削除することができます。
