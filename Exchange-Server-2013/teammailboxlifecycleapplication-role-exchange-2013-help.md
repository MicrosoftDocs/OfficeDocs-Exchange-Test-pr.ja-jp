---
title: 'TeamMailboxLifecycleApplication 役割: Exchange 2013 Help'
TOCTitle: TeamMailboxLifecycleApplication 役割
ms:assetid: 3cd2cd6f-65e1-4e66-a017-054060c46fe1
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ673057(v=EXCHG.150)
ms:contentKeyID: 49896211
ms.date: 04/24/2018
...
`TeamMailboxLifecycleApplication` 管理役割は、パートナー アプリケーションがサイト メールボックスのライフサイクル状態を更新できるようにします。
