---
title: "\"Cmdlet Extension Agents/コマンドレット拡張エージェント\" 役割: Exchange 2013 Help"
TOCTitle: "\"Cmdlet Extension Agents/コマンドレット拡張エージェント\" 役割"
ms:assetid: 20f9f7c2-a8e5-468e-b1a8-c87c562a2be7
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876857(v=EXCHG.150)
ms:contentKeyID: 49895287
ms.date: 04/24/2018
...
`Cmdlet Extension Agents` 管理役割を使用すると、管理者が組織内のコマンドレット拡張エージェントの有効化、無効化、および優先度の設定を行えます。
