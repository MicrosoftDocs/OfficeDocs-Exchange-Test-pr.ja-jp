...
2.  **\[UM ダイヤル プラン\]** ページの **\[UM 自動応答\]** で、勤務地を設定する UM 自動応答を選択し、**\[編集\]**![編集アイコン](images/Bb124582.6f53ccb2-1f13-4c02-bea0-30690e6ea71d(EXCHG.150).gif "編集アイコン") をクリックします。

3.  **\[UM 自動応答\]** ページの **\[全般\]** にある **\[会社名\]** に、会社の名前を入力します。
