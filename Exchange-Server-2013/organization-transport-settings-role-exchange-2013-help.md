---
title: "\"Organization Transport Settings/組織トランスポート設定\" 役割: Exchange 2013 Help"
TOCTitle: "\"Organization Transport Settings/組織トランスポート設定\" 役割"
ms:assetid: ff4d032e-1b97-4a9d-b479-9b0d61832221
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876961(v=EXCHG.150)
ms:contentKeyID: 49896575
ms.date: 04/24/2018
...
`Organization Transport Settings` 管理役割によって、管理者は組織全体にわたるトランスポート設定を管理できます。これにはシステム メッセージ、Active Directory サイト構成、および Exchange 組織全体のトランスポート構成設定が含まれます。

この役割では、送信コネクタと受信コネクタ、キュー、検疫、エージェント、リモート ドメインと承認済みドメイン、またはルールの作成や管理を行うことはできません。各トランスポート機能を作成または管理するには、次の役割のうち 1 つ以上に割り当てられている必要があります。
