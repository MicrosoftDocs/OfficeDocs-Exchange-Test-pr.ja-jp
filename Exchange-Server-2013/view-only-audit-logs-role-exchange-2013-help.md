---
title: "\"View-Only Audit Logs/表示専用監査ログ\" 役割: Exchange 2013 Help"
TOCTitle: "\"View-Only Audit Logs/表示専用監査ログ\" 役割"
ms:assetid: 9298fe59-0a16-4a09-bdb8-514d1cea6e2f
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Ff461933(v=EXCHG.150)
ms:contentKeyID: 49896373
ms.date: 04/24/2018
...
`View-Only Audit Logs` 管理役割により、管理者および専門家ユーザーが組織内で管理者監査ログを検索できるようになります。
