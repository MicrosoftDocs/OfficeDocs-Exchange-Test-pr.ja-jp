---
title: "\"Disaster Recovery/障害回復\" 役割: Exchange 2013 Help"
TOCTitle: "\"Disaster Recovery/障害回復\" 役割"
ms:assetid: 6dd321a8-7621-44be-b3c5-76535e006653
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876902(v=EXCHG.150)
ms:contentKeyID: 49896302
ms.date: 04/24/2018
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# \"Disaster Recovery/障害回復\" 役割
...
`Disaster Recovery` 管理役割を割り当てられた管理者は、組織内のメールボックスとメールボックス データベースのリストア、メールボックス データベースの作成、データベース可用性グループに対する切り替え/スイッチバックの実行を許可されます。
