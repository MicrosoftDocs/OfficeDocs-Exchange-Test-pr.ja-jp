---
title: 'MyPersonalInformation 役割: Exchange 2013 Help'
TOCTitle: MyPersonalInformation 役割
ms:assetid: 76848ea9-79db-4ac8-bdfa-eecc79394461
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Ff461932(v=EXCHG.150)
ms:contentKeyID: 49896322
ms.date: 04/24/2018
...
`MyPersonalInformation` 管理役割を使用すると、個々のユーザーは、自分の Web サイト アドレスおよび自宅の電話番号を表示、変更することができます。 これは、[MyContactInformation 役割](mycontactinformation-role-exchange-2013-help.md) 親役割から作成されたカスタムの役割です。
