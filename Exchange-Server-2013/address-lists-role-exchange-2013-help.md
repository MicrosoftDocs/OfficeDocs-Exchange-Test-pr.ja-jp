---
title: "\"Address Lists/アドレス一覧\" 役割: Exchange 2013 Help"
TOCTitle: "\"Address Lists/アドレス一覧\" 役割"
ms:assetid: 31143e30-16f5-45f5-b9a6-a39e6aa831d9
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876867(v=EXCHG.150)
ms:contentKeyID: 49896192
ms.date: 04/24/2018
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# \"Address Lists/アドレス一覧\" 役割
...
`Address Lists` 管理役割で、管理者は、アドレス一覧、グローバル アドレス一覧 (GAL)、アドレス帳ポリシー、組織内のオフライン アドレス一覧 (OAB) の作成、変更、表示、削除ができます。
