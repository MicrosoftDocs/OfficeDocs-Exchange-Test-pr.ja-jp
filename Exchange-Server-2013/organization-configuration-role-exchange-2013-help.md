---
title: "\"Organization Configuration/組織の構成\" 役割: Exchange 2013 Help"
TOCTitle: "\"Organization Configuration/組織の構成\" 役割"
ms:assetid: db952cc5-ef70-4366-acbb-0e292d4cbdd0
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876946(v=EXCHG.150)
ms:contentKeyID: 49896509
ms.date: 04/24/2018
...
管理者は `Organization Configuration` 管理役割を使用して、組織全体で設定を管理できます。この役割で制御できる組織の構成には、次に示すものなどがあります。

  - MailTips を組織に対し得ｔ有効または無効にするかどうか

  - 管理フォルダー ホーム ページの URL

  - Microsoft Exchange 受信者の SMTP アドレスおよび別の電子メール アドレス

  - リソース メールボックスのプロパティ スキーマの構成

  - Exchange 管理センターおよび Microsoft Office Outlook Web App のヘルプ URL

この種類の役割には、`Organization Client Access` 役割または `Organization Transport Settings` 役割に含まれるアクセス許可はありません。
