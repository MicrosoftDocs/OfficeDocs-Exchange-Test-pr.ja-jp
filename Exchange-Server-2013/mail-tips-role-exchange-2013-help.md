---
title: "\"Mail Tips/メール ヒント\" 役割: Exchange 2013 Help"
TOCTitle: "\"Mail Tips/メール ヒント\" 役割"
ms:assetid: 74495ded-6097-4f10-a829-c8ed81f5ba3e
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876909(v=EXCHG.150)
ms:contentKeyID: 49896317
ms.date: 04/24/2018
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# \"Mail Tips/メール ヒント\" 役割
...
管理者は Mail Tips (メール使用上のヒント) 管理役割を使用して、組織内のメール使用上のヒントを管理できます。
