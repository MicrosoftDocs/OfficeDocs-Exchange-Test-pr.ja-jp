---
title: "\"Public Folders/パブリック フォルダー\" 役割: Exchange 2013 Help"
TOCTitle: "\"Public Folders/パブリック フォルダー\" 役割"
ms:assetid: b858f04c-ac0b-495f-9193-8b9645781f73
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876930(v=EXCHG.150)
ms:contentKeyID: 49896434
ms.date: 04/24/2018
...
`Public Folders ` 管理役割により、管理者は組織内のパブリック フォルダーを管理することができます。

この役割を使用しても、パブリック フォルダーのメールが有効かどうか管理することはできません。パブリック フォルダーでメールを有効または無効にするには、`Mail Enabled Public Folders ` 役割に関連付けられた役割が割り当てられている必要があります。詳細については、「["Mail Enabled Public Folders/メールが有効なパブリック フォルダー" 役割](mail-enabled-public-folders-role-exchange-2013-help.md)」を参照してください。
