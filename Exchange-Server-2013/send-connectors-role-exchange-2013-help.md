---
title: "\"Send Connectors/送信コネクタ\" 役割: Exchange 2013 Help"
TOCTitle: "\"Send Connectors/送信コネクタ\" 役割"
ms:assetid: 8021e279-2b74-469e-aa6d-d0197f34ba6c
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876913(v=EXCHG.150)
ms:contentKeyID: 49896338
ms.date: 04/24/2018
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# \"Send Connectors/送信コネクタ\" 役割
...
`Send Connectors` 管理役割を割り当てられた管理者は、組織内のトランスポート送信コネクタを管理することができます。
