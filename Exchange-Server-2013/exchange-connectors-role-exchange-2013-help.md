---
title: "\"Exchange Connectors/Exchange コネクタ\" 役割: Exchange 2013 Help"
TOCTitle: "\"Exchange Connectors/Exchange コネクタ\" 役割"
ms:assetid: 73f98c82-bde0-443d-9bcf-274047e84e15
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876908(v=EXCHG.150)
ms:contentKeyID: 49896316
ms.date: 04/24/2018
...
`Exchange Connectors` 管理役割を割り当てられた管理者は、配信エージェント コネクタを作成、変更、表示、および削除できます。

この役割では、送信コネクタと受信コネクタを管理することはできません。送信コネクタと受信コネクタはそれぞれ、"Send Connectors/送信コネクタ" 役割と "Receive Connectors/受信コネクタ" 役割で管理します。詳細については、次のトピックを参照してください。
