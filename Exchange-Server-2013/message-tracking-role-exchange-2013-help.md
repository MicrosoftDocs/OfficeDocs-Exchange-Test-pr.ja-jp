---
title: "\"Message Tracking/メッセージ追跡\" 役割: Exchange 2013 Help"
TOCTitle: "\"Message Tracking/メッセージ追跡\" 役割"
ms:assetid: 21f18ccd-9b7d-461b-b77c-443d15696d79
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876858(v=EXCHG.150)
ms:contentKeyID: 49895291
ms.date: 04/24/2018
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# \"Message Tracking/メッセージ追跡\" 役割
...
`Message Tracking` 管理役割を使用すると、管理者が組織内のメッセージを追跡できます。
