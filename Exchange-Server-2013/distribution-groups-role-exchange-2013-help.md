---
title: "\"Distribution Groups/配布グループ\" 役割: Exchange 2013 Help"
TOCTitle: "\"Distribution Groups/配布グループ\" 役割"
ms:assetid: 0c3667b6-529b-4bb2-85bf-e24fae82d082
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876848(v=EXCHG.150)
ms:contentKeyID: 49895235
ms.date: 04/24/2018
...
`Distribution Groups` 管理役割により、管理者は配布グループを作成、変更、表示、および削除することと、組織内の配布グループ メンバーを追加および削除することができます。
