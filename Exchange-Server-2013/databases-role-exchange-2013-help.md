---
title: "\"Databases/データベース\" 役割: Exchange 2013 Help"
TOCTitle: "\"Databases/データベース\" 役割"
ms:assetid: 317d9945-668b-448e-963f-f7127b9b3d79
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876868(v=EXCHG.150)
ms:contentKeyID: 49896191
ms.date: 04/24/2018
...
`Databases` 管理役割で管理者は、サーバー単位でメールボックス データベースの作成、管理、マウント、マウントの解除ができます。
...
詳細については、「[管理役割スコープについて](understanding-management-role-scopes-exchange-2013-help.md)」を参照してください。
