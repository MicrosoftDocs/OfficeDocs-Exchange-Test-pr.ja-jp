---
title: "\"Migration/移行\" 役割: Exchange 2013 Help"
TOCTitle: "\"Migration/移行\" 役割"
ms:assetid: 8b5a3385-7dc0-4492-9f00-a4616982016b
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876920(v=EXCHG.150)
ms:contentKeyID: 49896354
ms.date: 04/24/2018
...
`Migration` 管理役割によって、管理者が、メールボックスとメールボックスの内容をサーバー内またはサーバー外へ移行できます。
