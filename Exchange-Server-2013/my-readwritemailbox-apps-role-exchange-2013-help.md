---
title: '自分の ReadWriteMailbox アプリの役割: Exchange 2013 Help'
TOCTitle: 自分の ReadWriteMailbox アプリの役割
ms:assetid: febb73fb-3a0b-4c67-b53b-9566d7c32cd2
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Mt793556(v=EXCHG.150)
ms:contentKeyID: 74418140
ms.date: 04/24/2018
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# 自分の ReadWriteMailbox アプリの役割

 

_**トピックの最終更新日:** 2017-02-08_

"自分の ReadWriteMailbox アプリ" ロールにより、個々のユーザーがマニフェストで ReadWriteMailbox のアクセス許可を要求するアドインを追加できます。
