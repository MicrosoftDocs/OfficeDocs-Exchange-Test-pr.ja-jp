---
title: "\"Mailbox Search/メールボックス検索\" 役割: Exchange 2013 Help"
TOCTitle: "\"Mailbox Search/メールボックス検索\" 役割"
ms:assetid: f86b63ba-0c67-4748-8965-0c08a6a8aec1
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876958(v=EXCHG.150)
ms:contentKeyID: 49896558
ms.date: 04/24/2018
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# \"Mailbox Search/メールボックス検索\" 役割
...
`Mailbox Search` 管理役割によって、管理者は組織内の 1 個または複数のメール ボックスの内容を検索することができます。
