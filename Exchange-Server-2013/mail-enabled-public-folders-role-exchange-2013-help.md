---
title: "\"Mail Enabled Public Folders/メールが有効なパブリック フォルダー\" 役割: Exchange 2013 Help"
TOCTitle: "\"Mail Enabled Public Folders/メールが有効なパブリック フォルダー\" 役割"
ms:assetid: 22289ae1-f9e8-4c98-aaad-ee623e05eadd
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876859(v=EXCHG.150)
ms:contentKeyID: 49895293
ms.date: 04/24/2018
...
`Mail Enabled Public Folders` 管理役割によって、管理者は組織内で個々のパブリック フォルダーのメールが有効であるか、無効であるかを構成できるようになります。

この役割によって、ユーザーはパブリック フォルダーの電子メール プロパティのみを管理できるようになります。電子メールに関連付けられていないパブリック フォルダーのプロパティを管理することはできません。電子メールに関連付けられていないパブリック フォルダーのプロパティを管理するには、`Public Folders` 役割を使用します。詳細については、「["Public Folders/パブリック フォルダー" 役割](public-folders-role-exchange-2013-help.md)」を参照してください。
