---
title: "\"Support Diagnostics/サポート診断\" 役割: Exchange 2013 Help"
TOCTitle: "\"Support Diagnostics/サポート診断\" 役割"
ms:assetid: 3ad2c628-019e-4eb7-af43-64ab2a3a2fbf
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876875(v=EXCHG.150)
ms:contentKeyID: 49896209
ms.date: 04/24/2018
...
`Support Diagnostics` 管理役割により、管理者は Microsoft カスタマー サービス & サポートの指示に基づいて、組織内で高度な診断を実行できます。


> [!NOTE]
> この役割は、カスタマー サービス &amp; サポートの指示の下でのみ使用できるコマンドレットおよびスクリプトにアクセス許可を付与します。
