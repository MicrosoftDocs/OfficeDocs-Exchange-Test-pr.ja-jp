---
title: 'LegalHoldApplication 役割: Exchange 2013 Help'
TOCTitle: LegalHoldApplication 役割
ms:assetid: 8ac0e939-14fe-4f64-9fae-ea5767bd1e2c
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ657468(v=EXCHG.150)
ms:contentKeyID: 49896353
ms.date: 04/24/2018
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# LegalHoldApplication 役割
...
`LegalHoldApplication` 管理役割により、パートナー アプリケーションはメールボックスの法的情報保留の状態を設定および表示できます。
