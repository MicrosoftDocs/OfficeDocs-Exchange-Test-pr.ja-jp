---
title: 'UserApplication 役割: Exchange 2013 Help'
TOCTitle: UserApplication 役割
ms:assetid: a4621e45-53db-42f7-a5d7-c1900a154b4e
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ657476(v=EXCHG.150)
ms:contentKeyID: 49896395
ms.date: 04/24/2018
...
`UserApplication` 管理役割は、パートナー アプリケーションがエンド ユーザーに代わって動作することを可能にします。
