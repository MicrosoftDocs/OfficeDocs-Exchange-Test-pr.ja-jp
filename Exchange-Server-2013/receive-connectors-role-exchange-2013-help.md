---
title: "\"Receive Connectors/受信コネクタ\" 役割: Exchange 2013 Help"
TOCTitle: "\"Receive Connectors/受信コネクタ\" 役割"
ms:assetid: a7c5a086-5066-4ece-9b22-cc1048d2f2bc
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876927(v=EXCHG.150)
ms:contentKeyID: 49896402
ms.date: 04/24/2018
...
管理者は `Receive Connectors` 管理役割を使用して、個別のサーバー上でのサイズ制限など、受信コネクタのトランスポート構成を管理できます。
