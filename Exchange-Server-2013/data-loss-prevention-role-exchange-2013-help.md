---
title: "\"Data Loss Prevention/データ損失防止\" 役割: Exchange 2013 Help"
TOCTitle: "\"Data Loss Prevention/データ損失防止\" 役割"
ms:assetid: 026d0e48-f4da-416e-a00d-794bd3b38c5c
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ673034(v=EXCHG.150)
ms:contentKeyID: 49895214
ms.date: 04/24/2018
...
データ損失防止管理の役割により、管理者はデータ損失防止 (DLP) のポリシーとポリシー内部のルールを作成および管理できるようになり、それらは組織全体のメール配信に影響する場合があります。さらにこの役割により、管理者は電子メール クライアントに表示されるポリシー ヒントを構成して DLP ポリシー違反レポートを管理できます。この DLP 役割により、Microsoft Exchange トランスポート ルールにアクセスすることもできます。Exchange のトランスポート ルールの詳細については、以下のトピックを参照してください。

  - ["Transport Rules/トランスポート ルール" 役割](transport-rules-role-exchange-2013-help.md)

  - [トランスポート ルールの新機能](what-s-new-for-transport-rules-exchange-2013-help.md)
