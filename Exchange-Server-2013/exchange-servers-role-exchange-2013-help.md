---
title: 'Exchange Servers 役割: Exchange 2013 Help'
TOCTitle: Exchange Servers 役割
ms:assetid: 5a626746-8d23-409c-a604-7e565c429990
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876887(v=EXCHG.150)
ms:contentKeyID: 49896264
ms.date: 04/24/2018
...
`Exchange Servers` 管理役割により、管理者が個々のサーバーで次の操作を実行できるようになります。

  - データベース可用性グループを追加および削除して、データベース コピーを構成する

  - ユニファイド メッセージング サービスを有効、無効および構成する

  - メールボックスおよびクライアント アクセス サーバー上のトランスポート構成を変更する

  - クライアント アクセス サーバーで Microsoft Outlook Anywhere を有効または無効にする

  - メールボックスおよびクライアント アクセス サーバーの構成を変更する

  - クライアント アクセス サーバーで Outlook Anywhere の構成を変更する

  - メールボックス サーバーでコンテンツ フィルターの構成を変更する

  - 一般的な Exchange サーバー構成を変更する
