---
title: "\"Reset Password/パスワードのリセット\" 役割: Exchange 2013 Help"
TOCTitle: "\"Reset Password/パスワードのリセット\" 役割"
ms:assetid: d80101f1-7e3d-4a61-b93a-23da23e95e93
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ657499(v=EXCHG.150)
ms:contentKeyID: 49896504
ms.date: 04/24/2018
...
"Reset Password/パスワードのリセット" 管理役割を使用すると、個々のユーザーが自分のパスワードをリセットしたり、管理者が組織内のユーザーのパスワードをリセットしたりできます。
