---
title: 'WorkloadManagement 役割: Exchange 2013 Help'
TOCTitle: WorkloadManagement 役割
ms:assetid: d5c90eae-95c3-44b0-add5-a97337d17743
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ657498(v=EXCHG.150)
ms:contentKeyID: 49896498
ms.date: 04/24/2018
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# WorkloadManagement 役割
...
管理者は `WorkloadManagement` 管理役割を使用して、ワークロード管理ポリシーを管理できます。管理者は、リソース正常性の定義、ワークロードの分類、ワークロード管理の有効化や無効化を構成できます。変更は、Microsoft カスタマー サービス/サポートの指示によってのみ行ってください。
