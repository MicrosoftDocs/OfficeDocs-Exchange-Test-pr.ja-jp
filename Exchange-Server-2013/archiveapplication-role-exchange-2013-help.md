---
title: 'ArchiveApplication 役割: Exchange 2013 Help'
TOCTitle: ArchiveApplication 役割
ms:assetid: 22d673cf-d3a3-43f0-be1e-e4fc74546e64
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ673046(v=EXCHG.150)
ms:contentKeyID: 49895295
ms.date: 04/24/2018
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# ArchiveApplication 役割
...
`ArchiveApplication` 管理役割は、パートナー アプリケーションがユーザー メールボックスのアイテムをアーカイブできるようにします。
