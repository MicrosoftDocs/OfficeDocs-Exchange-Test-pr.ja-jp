---
title: "\"Mailbox Import Export/メールボックスのインポートとエクスポート\" 役割: Exchange 2013 Help"
TOCTitle: "\"Mailbox Import Export/メールボックスのインポートとエクスポート\" 役割"
ms:assetid: d7cdce7a-6c46-4750-b237-d1c1773e8d28
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Ee633482(v=EXCHG.150)
ms:contentKeyID: 49896503
ms.date: 04/24/2018
...
管理者は `Mailbox Import Export` 管理役割を使用して、メールボックスの内容をインポートまたはエクスポートしたり、メールボックスから不要な内容を削除したりできます。
