---
title: 'MyDiagnostics 役割: Exchange 2013 Help'
TOCTitle: MyDiagnostics 役割
ms:assetid: 62ba4bdd-6301-4daf-9368-3b393213ec1d
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd979793(v=EXCHG.150)
ms:contentKeyID: 49896282
ms.date: 04/24/2018
...
`MyDiagnostics` 管理役割を割り当てられた個々のユーザーは、メールボックスに対して診断情報の検索などの基本的な診断を実行することができます。
