---
title: "\"UM Prompts/UM プロンプト\" 役割: Exchange 2013 Help"
TOCTitle: "\"UM Prompts/UM プロンプト\" 役割"
ms:assetid: 262928e8-b938-404f-b941-a636f4d18169
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876861(v=EXCHG.150)
ms:contentKeyID: 49895301
ms.date: 04/24/2018
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# \"UM Prompts/UM プロンプト\" 役割
...
管理者は `UM Prompts` 管理役割を使用して、組織内でユニファイド メッセージング (UM) カスタム音声プロンプトを作成および管理できます。
