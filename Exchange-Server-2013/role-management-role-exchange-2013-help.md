---
title: "\"Role Management/役割管理\" 役割: Exchange 2013 Help"
TOCTitle: "\"Role Management/役割管理\" 役割"
ms:assetid: 71d8553c-150d-4306-8de0-89be6efb5e40
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876906(v=EXCHG.150)
ms:contentKeyID: 49896310
ms.date: 04/24/2018
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# \"Role Management/役割管理\" 役割
...
`Role Management` 管理役割を割り当てられた管理者はそれぞれ、組織内の管理役割グループの管理、役割割り当てポリシーと管理役割の管理、役割のエントリ、割り当ておよびスコープの管理ができます。

この役割を割り当てられたユーザーは、プロパティで管理される役割グループを上書きすることも、任意の役割グループを構成することも、任意の役割グループのメンバーを追加または削除することもできます。
