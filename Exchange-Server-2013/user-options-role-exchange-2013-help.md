---
title: "\"User Options/ユーザー オプション\" 役割: Exchange 2013 Help"
TOCTitle: "\"User Options/ユーザー オプション\" 役割"
ms:assetid: fb4d58f5-cc62-4ce8-b2e4-c3cc91795a12
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dd876960(v=EXCHG.150)
ms:contentKeyID: 49896562
ms.date: 04/24/2018
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# \"User Options/ユーザー オプション\" 役割
...
`User Options` 管理役割によって、管理者が組織内のユーザーの Outlook Web App のオプションを表示することができます。この役割は構成の問題を診断するために使用できます。
