---
title: "\"Org Custom Apps/組織のカスタム アプリ\" 役割: Exchange 2013 Help"
TOCTitle: "\"Org Custom Apps/組織のカスタム アプリ\" 役割"
ms:assetid: ab2aac13-f783-43e6-a369-75cce1d4943f
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ657482(v=EXCHG.150)
ms:contentKeyID: 49896410
ms.date: 04/24/2018
...
Org Custom Apps 管理役割を使用すると、管理者は組織のアプリを表示または変更し、ファイルあるいは URL からカスタム アプリを追加できます。
